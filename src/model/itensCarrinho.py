...
class ItensCarrinho:
    ...
    def to_string(self) -> str:
        return f"Itens Carrinho: {self.get_codigo_itensCarrinho()} | Data: {self.get_data_itensCarrinho()} | Carrinho: {self.get_carrinho().get_id_carrinho()} | Produto: {self.get_produto().get_nome()}"