...
class Relatorio:
    def __init__(self):
        ...
        with open("/home/labdatabase/Downloads/WevertonTrabalho/src/sql/relatorio_itensCarrinhos.sql") as f:
            self.query_relatorio_itensCarrinhos = f.read()

        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("/home/labdatabase/Downloads/WevertonTrabalho/src/sql/relatorio_itensCarrinhos_por_carrinho.sql") as f:
            self.query_relatorio_itensCarrinhos_por_carrinho = f.read()

        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("/home/labdatabase/Downloads/WevertonTrabalho/src/sql/relatorio_carrinhos.sql") as f:
            self.query_relatorio_carrinhos = f.read()

        # Abre o arquivo com a consulta e associa a um atributo da classe
        with open("/home/labdatabase/Downloads/WevertonTrabalho/src/sql/relatorio_produtos.sql") as f:
